...
ast = {"lemma_lookup": get_file("ast_lemma_lookup.json")
}
bg = {"lemma_lookup": get_file("bg_lemma_lookup.json")
}
et = {"lemma_lookup": get_file("et_lemma_lookup.json")
}
sk = {"lemma_lookup": get_file("sk_lemma_lookup.json")
}
sl = {"lemma_lookup": get_file("sl_lemma_lookup.json")
}
mk = {
...
cy = {
    "lemma_rules": get_file("cy_lemma_rules.json"),
    "lemma_index": get_file("cy_lemma_index.json"),
    "lemma_lookup": get_file("cy_lemma_lookup.json"),
    "ipa_lookup": get_file("cy_ipa_lookup.json"),
}
es = {
...
fa = {
    "lemma_lookup": get_file("fa_lemma_lookup.json"),
...
ga = {
    "lemma_lookup": get_file("ga_lemma_lookup.json"),
    ...
    "ipa_lookup": get_file("ga_ipa_lookup.json"),
}
gd = {
    "lemma_rules": get_file("gd_lemma_rules.json"),
    "ipa_lookup": get_file("gd_ipa_lookup.json"),
    "lemma_index": get_file("gd_lemma_index.json"),
    "lemma_lookup": get_file("gd_lemma_lookup.json"),
}
gl = {"lemma_lookup": get_file("gl_lemma_lookup.json")
}
gv = {
    "lemma_rules": get_file("gv_lemma_rules.json"),
    "lemma_index": get_file("gv_lemma_index.json"),
    "lemma_lookup": get_file("gv_lemma_lookup.json"),
    "ipa_lookup": get_file("gv_ipa_lookup.json"),
}
nb = {
